...
from moya.driver_db import init_connect_db, add_newcard, is_rfid_sw, get_rfid_sw, get_userinfo_sw, set_exit_sw, set_attendance_sw
import logging
        ...
        if rst[0] != "not support the platform.":
            ...
            if rst[1] != None:
                ...
                if is_rfid_sw(db, rfid_uid)['cnt'] == 0:
                    # 새로운 카드 등록시 수원바른샘서관은 4번의 db 번호로 강제정의
